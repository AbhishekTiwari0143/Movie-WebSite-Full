  ...
  return (
    <div className="p-3">
      <form action="" onSubmit={handleSubmit} className="space-y-3">
        <input
          type="text"
          className="py-3 px-4 rounded-lg w-[60rem]"
        ...
        <div className="flex justify-between">
          ...
          {handleDelete && (
            <button
              ...
              className="bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50"
            >
              Delete
            </button>
          )}
